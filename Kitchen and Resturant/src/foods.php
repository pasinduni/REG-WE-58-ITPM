        ...
        <?php
            ...
            <form action="fupdate.php" method="POST">
                    ...
                    <form action="delete.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $row['fid'] ?>">
                        <button type="submit" name="delete" class="btn btn-danger" id="del"> DELETE </button>
                    </form>
          </td>
            </tr>
            ...
            ?>
             ...
             <a href="fcreate.php" class="btn btn-primary" id="add">ADD</a>
    </div>
